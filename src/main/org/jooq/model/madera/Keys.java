...
import org.jooq.model.madera.tables.records.AdresseRecord;
...
import org.jooq.model.madera.tables.records.ComposantGroupeRecord;
import org.jooq.model.madera.tables.records.ComposantRecord;
import org.jooq.model.madera.tables.records.ComposantReferentielRecord;
import org.jooq.model.madera.tables.records.DevisEtatRecord;
import org.jooq.model.madera.tables.records.FournisseurRecord;
...
import org.jooq.model.madera.tables.records.ModuleRecord;
import org.jooq.model.madera.tables.records.ModuleReferentielRecord;
import org.jooq.model.madera.tables.records.ProjetModuleRecord;
import org.jooq.model.madera.tables.records.ProjetRecord;
import org.jooq.model.madera.tables.records.ProjetUtilisateursRecord;
import org.jooq.model.madera.tables.records.RoleRecord;
import org.jooq.model.madera.tables.records.UtilisateurRecord;
...
public class Keys {
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<ClientAdresseRecord, ClientRecord> CLIENT_ADRESSE__FK_CLIENT_2 = Internal.createForeignKey(org.jooq.model.madera.Keys.CLIENT_PKEY, ClientAdresse.CLIENT_ADRESSE, "client_adresse__fk_client_2", ClientAdresse.CLIENT_ADRESSE.I_CLIENT_ID);
        public static final ForeignKey<ClientAdresseRecord, AdresseRecord> CLIENT_ADRESSE__FK_ADRESSE_2 = Internal.createForeignKey(org.jooq.model.madera.Keys.ADRESSE_PKEY, ClientAdresse.CLIENT_ADRESSE, "client_adresse__fk_adresse_2", ClientAdresse.CLIENT_ADRESSE.I_ADRESSE_ID);
        public static final ForeignKey<ComposantRecord, ComposantGroupeRecord> COMPOSANT__FK_COMPOSANT_GROUPE = Internal.createForeignKey(org.jooq.model.madera.Keys.COMPOSANT_GROUPE_PKEY, Composant.COMPOSANT, "composant__fk_composant_groupe", Composant.COMPOSANT.I_COMPOSANT_GROUPE_ID);
        public static final ForeignKey<ComposantRecord, ComposantReferentielRecord> COMPOSANT__FK_COMPOSANT_REFERENTIEL = Internal.createForeignKey(org.jooq.model.madera.Keys.COMPOSANT_REFERENTIEL_PKEY, Composant.COMPOSANT, "composant__fk_composant_referentiel", Composant.COMPOSANT.I_COMPOSANT_REFERENTIEL_ID);
        public static final ForeignKey<ComposantFournisseurRecord, ComposantRecord> COMPOSANT_FOURNISSEUR__FK_COMPOSANT_2 = Internal.createForeignKey(org.jooq.model.madera.Keys.COMPOSANT_PKEY, ComposantFournisseur.COMPOSANT_FOURNISSEUR, "composant_fournisseur__fk_composant_2", ComposantFournisseur.COMPOSANT_FOURNISSEUR.I_COMPOSANT_ID);
        public static final ForeignKey<ComposantFournisseurRecord, FournisseurRecord> COMPOSANT_FOURNISSEUR__FK_FOURNISSEUR = Internal.createForeignKey(org.jooq.model.madera.Keys.FOURNISSEUR_PKEY, ComposantFournisseur.COMPOSANT_FOURNISSEUR, "composant_fournisseur__fk_fournisseur", ComposantFournisseur.COMPOSANT_FOURNISSEUR.I_FOURNISSEUR_ID);
        public static final ForeignKey<FournisseurRecord, AdresseRecord> FOURNISSEUR__FK_ADRESSE_2 = Internal.createForeignKey(org.jooq.model.madera.Keys.ADRESSE_PKEY, Fournisseur.FOURNISSEUR, "fournisseur__fk_adresse_2", Fournisseur.FOURNISSEUR.I_ADRESSE_ID);
        public static final ForeignKey<ModuleRecord, GammesRecord> MODULE__FK_GAMMES = Internal.createForeignKey(org.jooq.model.madera.Keys.GAMMES_PKEY, Module.MODULE, "module__fk_gammes", Module.MODULE.I_GAMMES_ID);
        public static final ForeignKey<ModuleRecord, ModuleReferentielRecord> MODULE__FK_MODULE_REFERENTIEL = Internal.createForeignKey(org.jooq.model.madera.Keys.MODULE_REFERENTIEL_PKEY, Module.MODULE, "module__fk_module_referentiel", Module.MODULE.I_MODULE_REFERENTIEL_ID);
        public static final ForeignKey<ModuleComposantRecord, ModuleRecord> MODULE_COMPOSANT__FK_MODULE = Internal.createForeignKey(org.jooq.model.madera.Keys.MODULE_PKEY, ModuleComposant.MODULE_COMPOSANT, "module_composant__fk_module", ModuleComposant.MODULE_COMPOSANT.I_MODULE_ID);
        public static final ForeignKey<ModuleComposantRecord, ComposantRecord> MODULE_COMPOSANT__FK_COMPOSANT = Internal.createForeignKey(org.jooq.model.madera.Keys.COMPOSANT_PKEY, ModuleComposant.MODULE_COMPOSANT, "module_composant__fk_composant", ModuleComposant.MODULE_COMPOSANT.I_COMPOSANT_ID);
        public static final ForeignKey<ProjetRecord, ClientRecord> PROJET__FK_CLIENT = Internal.createForeignKey(org.jooq.model.madera.Keys.CLIENT_PKEY, Projet.PROJET, "projet__fk_client", Projet.PROJET.I_CLIENT_ID);
        public static final ForeignKey<ProjetRecord, DevisEtatRecord> PROJET__FK_DEVIS_ETAT = Internal.createForeignKey(org.jooq.model.madera.Keys.DEVIS_ETAT_PKEY, Projet.PROJET, "projet__fk_devis_etat", Projet.PROJET.I_DEVIS_ETAT_ID);
        public static final ForeignKey<ProjetModuleRecord, ProjetRecord> PROJET_MODULE__FK_PROJET_2 = Internal.createForeignKey(org.jooq.model.madera.Keys.PROJET_PKEY, ProjetModule.PROJET_MODULE, "projet_module__fk_projet_2", ProjetModule.PROJET_MODULE.I_PROJET_ID);
        public static final ForeignKey<ProjetModuleRecord, ModuleRecord> PROJET_MODULE__FK_MODULE_2 = Internal.createForeignKey(org.jooq.model.madera.Keys.MODULE_PKEY, ProjetModule.PROJET_MODULE, "projet_module__fk_module_2", ProjetModule.PROJET_MODULE.I_MODULE_ID);
        public static final ForeignKey<ProjetUtilisateursRecord, UtilisateurRecord> PROJET_UTILISATEURS__FK_UTILISATEURS = Internal.createForeignKey(org.jooq.model.madera.Keys.UTILISATEUR_PKEY, ProjetUtilisateurs.PROJET_UTILISATEURS, "projet_utilisateurs__fk_utilisateurs", ProjetUtilisateurs.PROJET_UTILISATEURS.I_UTILISATEUR_ID);
        public static final ForeignKey<ProjetUtilisateursRecord, ProjetRecord> PROJET_UTILISATEURS__FK_PROJET_3 = Internal.createForeignKey(org.jooq.model.madera.Keys.PROJET_PKEY, ProjetUtilisateurs.PROJET_UTILISATEURS, "projet_utilisateurs__fk_projet_3", ProjetUtilisateurs.PROJET_UTILISATEURS.I_PROJET_ID);
        public static final ForeignKey<UtilisateurRecord, RoleRecord> UTILISATEUR__FK_ROLE = Internal.createForeignKey(org.jooq.model.madera.Keys.ROLE_PKEY, Utilisateur.UTILISATEUR, "utilisateur__fk_role", Utilisateur.UTILISATEUR.I_ROLE_ID);
    }
}
